    ...
    >
      ...
      <div className="queue-header">
        <div className="queue-header-title-section">
          ...
          <span className="queue-header-title">朗读队列</span>
          ...
          <div className="queue-header-buttons-row">
            ...
            {queue.length > 0 && (
              <button
                ...
                title={loopEnabled ? "循环播放已开启" : "循环播放已关闭"}
              >
      ...
      >
        {queue.length === 0 ? (
          <div className="queue-empty-message">
            ...
            <div className="queue-empty-title">队列为空</div>
            <div className="queue-empty-instructions">
              你可以通过以下方式添加朗读内容：
            </div>
            <div className="queue-empty-instruction-list">
              <div>• 在笔记上右键选择加入队列</div>
              <div>• 使用“加入朗读队列”菜单项</div>
              <div>• 使用命令面板快捷操作</div>
            </div>
          </div>
        ) : (
